...
@Component({
  selector: 'app-lead-refrence',
  templateUrl: './lead-refrence.component.html',
  styleUrls: ['./lead-refrence.component.css']
})
export class LeadRefrenceComponent implements OnInit {
