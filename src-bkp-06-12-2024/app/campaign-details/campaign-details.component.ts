...
export class CampaignDetailsComponent implements OnInit {
  ...
  constructor(private _location: Location, private http: HttpClient,public HeadingServices: HeadingServicesService, private route: Router,private router: ActivatedRoute ,private bridgeService2: BridgeService,private _NotifierService: NotiferService) {
      ...
      (res: any) => {
        if (Object(res)['status'] == "200") {
          ...
          for(let i=0;i<this.DynamicFiledPositionDetials.length;i++){
            this.compaign[this.DynamicFiledPositionDetials[i].field_name] = '';
          }
        }
        else {
