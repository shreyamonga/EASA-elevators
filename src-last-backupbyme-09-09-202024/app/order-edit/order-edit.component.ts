      ...
      (data: Orders[]) => {
       ...
       // console.log('order-edit123',this.orders2);
        ...
        for (let i = 0; i < this.orders2[0].DocumentLines.length; i++) {
         ...
         var total=((this.orders2[0].DocumentLines[i].Quantity * this.orders2[0].DocumentLines[i].UnitPrice - (this.orders2[0].DocumentLines[i].Quantity * this.orders2[0].DocumentLines[i].UnitPrice * (this.orders2[0].DocumentLines[i].DiscountPercent/100))) + ((this.orders2[0].DocumentLines[i].Quantity * this.orders2[0].DocumentLines[i].UnitPrice - (this.orders2[0].DocumentLines[i].Quantity * this.orders2[0].DocumentLines[i].UnitPrice * (this.orders2[0].DocumentLines[i].DiscountPercent/100)))*((this.orders2[0].DocumentLines[i].Tax||0)/100))).toFixed(2);
        ...
        for (let i = 0; i < this.order.DocumentLines.length; i++) {
          this.QuatItems.push({
            ...
            Tax: this.order.DocumentLines[i].Tax || 0,
          });
        }
...
// console.log('item',item);
  ...
  sendarray() {
    ...
    for (let i = 0; i < this.QuatItems.length; i++) {
     ...
     var total=((this.QuatItems[i].Quantity * this.QuatItems[i].UnitPrice - (this.QuatItems[i].Quantity * this.QuatItems[i].UnitPrice * (this.QuatItems[i].DiscountPercent/100))) + ((this.QuatItems[i].Quantity * this.QuatItems[i].UnitPrice - (this.QuatItems[i].Quantity * this.QuatItems[i].UnitPrice * (this.QuatItems[i].DiscountPercent/100)))*(this.QuatItems[i].Tax/100))).toFixed(2);
      totalamount.push(total);
    }
    this.total_Amount=totalamount.reduce((a:any, b:any) => a + Number(b), 0);
