...
export class SplitComponent implements OnInit {
  ...
  Headingss: any[] = [];
  constructor(private router: Router, public datepipe: DatePipe, private bridgeService2: BridgeService, private http: HttpClient, configtab: NgbNavConfig, private modalService: NgbModal,private HeadingServices: HeadingServicesService,private _NotifierService: NotiferService,) {
