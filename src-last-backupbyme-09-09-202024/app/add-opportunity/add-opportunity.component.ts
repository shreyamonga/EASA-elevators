...
export class AddOpportunityComponent implements OnInit {
  ...
  constructor(private bridgeService2: BridgeService, private _NotifierService: NotiferService,private HeadingServices: HeadingServicesService, private cdref: ChangeDetectorRef, private router: Router, private modalService: NgbModal, private http: HttpClient,
