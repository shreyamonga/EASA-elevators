...
export class CustomerEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getBridge();
    this.getDynaimcFld('BusinessPartner');
    this.getIndustory();
    this.getCountry();
    ...
    this.bridgeService2.getOneCustomerdata(this.Cidd).subscribe(
      (data: any[]) => {
       ...
       // console.log("this.editcustomer.BPAddresses[0].Country",this.editcustomer.BPAddresses[0].Country);
        ...
        for(let i=0;i<this.DynamicFiledPositionDetials.length;i++){
          if(data[0][this.DynamicFiledPositionDetials[i].field_name] == null){
            data[0][this.DynamicFiledPositionDetials[i].field_name] = '';
          }
          this.editcustomer[this.DynamicFiledPositionDetials[i].field_name] = data[0][this.DynamicFiledPositionDetials[i].field_name];
        }
...
this.editcustomer.CreateDate= this.HeadingServices.getDate(),
