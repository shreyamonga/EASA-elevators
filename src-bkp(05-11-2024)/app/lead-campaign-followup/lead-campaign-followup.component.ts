...
@Component({
  selector: 'app-lead-campaign-followup',
  templateUrl: './lead-campaign-followup.component.html',
  styleUrls: ['./lead-campaign-followup.component.css']
})
export class LeadCampaignFollowupComponent implements OnInit {
