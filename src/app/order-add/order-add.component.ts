  ...
  getOrder(idd:any): void {
    ...
    this.bridgeService2.getOneOrderdata(idd).subscribe(
      (data: any[]) => {
        ...
        for(let i=0;i<this.DynamicFiledPositionDetials.length;i++){
          if(this.quotations[0][this.DynamicFiledPositionDetials[i].field_name] == null){
            this.quotations[0][this.DynamicFiledPositionDetials[i].field_name] = '';
          }
          this.order[this.DynamicFiledPositionDetials[i].field_name] = this.quotations[0][this.DynamicFiledPositionDetials[i].field_name];
        }
