...
export class ExcelsheetComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    private _NotifierService: NotiferService, public datepipe: DatePipe, private http: HttpClient, private bridgeService2: BridgeService, private modalService: NgbModal) {
