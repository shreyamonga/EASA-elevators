...
data: [][] | undefined;
  ...
  constructor(private router: Router,public datepipe: DatePipe, private http: HttpClient, private bridgeService2: BridgeService, configtab: NgbNavConfig, private modalService: NgbModal) {
