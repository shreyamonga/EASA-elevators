...
import { Stages, CreateStages, ChangeStages, SecondStage , ThirdStage ,Negotiation1Stage ,Negotiation2Stage,OrderConfirmationStage,PreNIStage,
  Negotiation3Stage,OrderBookingStage,
   ClosureStage, CompleteStages, 
   PreNIChecklist , EditChecklist} from '../stage';
          ...
          if (this.stages[i]['Status'] == 2 || this.stages[i]['Status'] == 3) {
            ...
            if(this.stages[0]){
              ...
              this.CabinInteriorFinishVal
                = this.stages[i].StageDetail[0]['CabinInteriorFinish'];
            ...
            if(this.stages[1]){
              ...
              = this.stages[1].StageDetail[0]['DrawingToBeSharedBy']
...
this.Negotiation1stage.ApprovalStatus = this.nego1ApprovalStatus
...
SalesToPreAttachment(): boolean {
 ...
 if (this.selectedMomFormAttachment.length === 0) {
