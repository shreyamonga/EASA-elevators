...
export class DashboardComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal,
    private HeadingServices: HeadingServicesService, public datepipe: DatePipe, private bridgeService: BridgeService, private route: Router, private http: HttpClient) {
