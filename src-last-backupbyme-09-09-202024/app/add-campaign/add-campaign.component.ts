...
export class AddCampaignComponent implements OnInit {
  ...
  constructor(private _location: Location, private _NotifierService: NotiferService, private route: Router, private router: Router, private bridgeService: BridgeService, private modalService: NgbModal,
  ...
  ngOnInit(): void {
    ...
    console.log('this.CampaignAccess',this.CampaignAccess);
