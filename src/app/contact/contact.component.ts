...
export class ContactComponent implements OnInit {
  ...
  AddFollow2: AddFollow2 = { "Subject": "", "Mode": "", "Comment": "",
     ...
     "CreateTime": this.time,
      "Emp": '',
      "Emp_Name": "", "From": this.newdate, "SourceID": "82", "SourceType": "", "Time": this.inputElementTime, "Type": "Followup", "leadType": '' };
...
// console.log(this.bridgesdetails[0].companyName);
  ...
  addFollowUp(fb: NgForm) {
    ...
    if (fb.valid) {
      ...
      this.AddFollow2.CreateDate= this.newdate, 
      this.AddFollow2.CreateTime= this.time,
