...
export class ProductComponent implements OnInit {
     ...
     product: Product =  {ItemName:'', ItemCode:'',Description:'',UnitPrice:'',Currency: '',
     HSN: '',
     TaxCode: '',
     Discount:'',
     Status:'1',
     ...
     UpdatedTime: this.time};
      ...
      resetAlerts() {
       ...
       getBridge(): void {
        this.bridgeService.getproductdata().subscribe(
          (data: Product[]) => {
            this.products = data;
      ...
      addUser(f: NgForm) {
        ...
        this.resetAlerts();
        this.isLoading = true;
        this.bridgeService.storeProduct(this.product).subscribe(
          (res: Product) => {
