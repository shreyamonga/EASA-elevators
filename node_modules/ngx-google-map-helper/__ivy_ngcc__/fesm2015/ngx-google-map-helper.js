import { Injectable, Optional, Component, ElementRef, Input, Output, EventEmitter, NgModule } from '@angular/core';
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class NgxGoogleMapHelperService {
    /**
     * @param {?} config
     */
    constructor(config) {
...
NgxGoogleMapHelperService.ɵfac = function NgxGoogleMapHelperService_Factory(t) { return new (t || NgxGoogleMapHelperService)(ɵngcc0.ɵɵinject(MapConfig, 8)); };
NgxGoogleMapHelperService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: NgxGoogleMapHelperService, factory: NgxGoogleMapHelperService.ɵfac, providedIn: 'root' });
NgxGoogleMapHelperService.decorators = [ { type: Injectable }
];
/** @nocollapse */
NgxGoogleMapHelperService.ctorParameters = () => [
    { type: MapConfig, decorators: [{ type: Optional }] }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxGoogleMapHelperService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
        ...
        type: Injectable
    }], function () { return [{ type: MapConfig, decorators: [{
                type: Optional
            }] }]; }, null); })();
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class NgxGoogleMapHelperComponent {
    /**
     * @param {?} elementRef
     * @param {?} mapService
     */
    constructor(elementRef, mapService) {
        ...
        this.placeMarkerOnClick = false;
        this.showControl = true;
        this.position = defaultValues.handlerPositions[0];
        this.showModes = defaultValues.drawingModes;
        this.locationAccess = false;
        this.commonOption = defaultValues.defaultOverlayValues;
        this.markerOption = defaultValues.defaultMarkerValues;
        this.customButtons = true;
        this.onlyCustomButtons = [];
        this.googleMapObjects = false;
        this.showErrors = true;
        this.shapes = [];
        // outputs
        this.mapClicked = new EventEmitter();
        this.overlayCompleted = new EventEmitter();
        this.overlaySelected = new EventEmitter();
        this.saveSeleted = new EventEmitter();
        this.saveAll = new EventEmitter();
        this.isWorldView = false;
        this.allOverlays = [];
        this.customButtonsList = defaultValues.customButtons;
    ...
    setUpWorldView() {
        /** @type {?} */
        const allowedBounds = new google.maps.LatLngBounds(new google.maps.LatLng(85, -180), // top left corner of map
    ...
    initCustomButtons(map) {
        ...
        if (this.onlyCustomButtons && this.onlyCustomButtons.length > 0) {
            showButtons = this.customButtonsList.filter((/**
             * @param {?} a
             * @return {?}
             */
            a => this.onlyCustomButtons.includes(a.key)));
        }
     ...
     * @return {?}
     */
    handleCustomButtonEvent(button) {
        switch (button) {
            case 'undo': {
                this.undoShape();
                break;
    ...
    getOverlayType(object) {
        ...
        if (object.type === 'circle') {
            /** @type {?} */
            const center = { lat: overlay.center.lat(), lng: overlay.center.lng() };
            /** @type {?} */
            const circle = { center, radius: overlay.radius };
            shape = {
                type: object.type,
                shape: circle
            };
            ...
            /** @type {?} */
            const center = { lat: overlay.map.center.lat(), lng: overlay.map.center.lng() };
            /** @type {?} */
            ...
            /** @type {?} */
            const neBound = { lat: bounds.getNorthEast().lat(), lng: bounds.getNorthEast().lng() };
            /** @type {?} */
            const swBound = { lat: bounds.getSouthWest().lat(), lng: bounds.getSouthWest().lng() };
            /** @type {?} */
            const rectangle = { center, northEastBound: neBound, southWestBound: swBound };
            shape = {
                type: object.type,
                shape: rectangle
            };
            ...
            const center = { lat: overlay.map.center.lat(), lng: overlay.map.center.lng() };
            /** @type {?} */
            const position = { lat: overlay.position.lat(), lng: overlay.position.lng() };
            /** @type {?} */
            const marker = { center, position };
            shape = {
                type: object.type,
                shape: marker
            };
        ...
        if (shapes && shapes.length > 0) {
            for (let i = 0; i < shapes.length; i++) {
                ...
                if (shape.type === 'marker') {
                    ...
                    /** @type {?} */
                    const rectangleObj = shape.shape;
                    /** @type {?} */
...
NgxGoogleMapHelperComponent.ɵfac = function NgxGoogleMapHelperComponent_Factory(t) { return new (t || NgxGoogleMapHelperComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(NgxGoogleMapHelperService)); };
NgxGoogleMapHelperComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: NgxGoogleMapHelperComponent, selectors: [["ngx-google-map-helper"]], inputs: { mapHeight: "mapHeight", mapWidth: "mapWidth", zoom: "zoom", center: "center", mapType: "mapType", placeMarkerOnClick: "placeMarkerOnClick", showControl: "showControl", position: "position", showModes: "showModes", locationAccess: "locationAccess", commonOption: "commonOption", markerOption: "markerOption", customButtons: "customButtons", onlyCustomButtons: "onlyCustomButtons", googleMapObjects: "googleMapObjects", showErrors: "showErrors", shapes: "shapes", circleOption: "circleOption", polygonOption: "polygonOption", polylineOption: "polylineOption", rectangleOption: "rectangleOption" }, outputs: { mapClicked: "mapClicked", overlayCompleted: "overlayCompleted", overlaySelected: "overlaySelected", saveSeleted: "saveSeleted", saveAll: "saveAll" }, decls: 2, vars: 4, consts: [[1, "map-wrapper", 3, "ngStyle"], ["id", "map", 1, "google-map", 2, "height", "100%", "margin", "0"]], template: function NgxGoogleMapHelperComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "div", 0);
        ɵngcc0.ɵɵelement(1, "div", 1);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c0, ctx.mapWidth, ctx.mapHeight));
    } }, dependencies: [ɵngcc1.NgStyle], styles: [".map-wrapper[_ngcontent-%COMP%]{position:relative;left:0;bottom:0}"] });
/** @nocollapse */
NgxGoogleMapHelperComponent.ctorParameters = () => [
    { type: ElementRef },
    { type: NgxGoogleMapHelperService }
];
NgxGoogleMapHelperComponent.propDecorators = {
    mapHeight: [{ type: Input }],
    mapWidth: [{ type: Input }],
    zoom: [{ type: Input }],
    center: [{ type: Input }],
    mapType: [{ type: Input }],
    placeMarkerOnClick: [{ type: Input }],
    showControl: [{ type: Input }],
    position: [{ type: Input }],
    showModes: [{ type: Input }],
    locationAccess: [{ type: Input }],
    commonOption: [{ type: Input }],
    circleOption: [{ type: Input }],
    polygonOption: [{ type: Input }],
    polylineOption: [{ type: Input }],
    rectangleOption: [{ type: Input }],
    markerOption: [{ type: Input }],
    customButtons: [{ type: Input }],
    onlyCustomButtons: [{ type: Input }],
    googleMapObjects: [{ type: Input }],
    showErrors: [{ type: Input }],
    shapes: [{ type: Input }],
    mapClicked: [{ type: Output }],
    overlayCompleted: [{ type: Output }],
    overlaySelected: [{ type: Output }],
    saveSeleted: [{ type: Output }],
    saveAll: [{ type: Output }]
};
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxGoogleMapHelperComponent, [{
        type: Component,
        args: [{ selector: 'ngx-google-map-helper', template: "\r\n<div class=\"map-wrapper\" [ngStyle]=\"{'width': mapWidth, 'height': mapHeight}\">\r\n  <div id=\"map\" class=\"google-map\" style=\"height:100%; margin: 0\"></div>\r\n</div>\r\n\r\n  ", styles: [".map-wrapper{position:relative;left:0;bottom:0}"] }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: NgxGoogleMapHelperService }]; }, { mapHeight: [{
            type: Input
        }], mapWidth: [{
            type: Input
        }], zoom: [{
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class NgxGoogleMapHelperModule {
    /**
     * @param {?} config
     * @return {?}
     */
...
NgxGoogleMapHelperModule.ɵfac = function NgxGoogleMapHelperModule_Factory(t) { return new (t || NgxGoogleMapHelperModule)(); };
NgxGoogleMapHelperModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: NgxGoogleMapHelperModule });
NgxGoogleMapHelperModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [NgxGoogleMapHelperService], imports: [CommonModule] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxGoogleMapHelperModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxGoogleMapHelperModule, { declarations: function () { return [NgxGoogleMapHelperComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [NgxGoogleMapHelperComponent]; } }); })();
...
export { NgxGoogleMapHelperService, NgxGoogleMapHelperComponent, NgxGoogleMapHelperModule, MapConfig as ɵa };

//# sourceMappingURL=ngx-google-map-helper.js.map