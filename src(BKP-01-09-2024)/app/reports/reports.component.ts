...
export class ReportsComponent implements OnInit {
  ...
  AllReportList:boolean = false;
  ModuleItem:any = '';
  ModuleItemSub:any = '';
  ReportHistoryActive: boolean = false;
  count = new Array();
  ...
  setModule(item:any){
    ...
    this.ReportHistoryActive = false;
    this.AllReportList = false
    this.ModuleItemSub = '';
  ...
  goDetail(item: any,data?:any){
    ...
    this.bridgeService2.reportDetails(item.id,this.pagination2,this.searchValue,this.filterfield,'').subscribe(
      (data: any) => {
