...
export class AddOpportunityComponent implements OnInit {
  ...
  constructor(private bridgeService2: BridgeService, private _NotifierService: NotiferService,public HeadingServices: HeadingServicesService, private cdref: ChangeDetectorRef, private router: Router, private modalService: NgbModal, private http: HttpClient,private route: ActivatedRoute,
