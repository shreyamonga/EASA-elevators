...
export class CampaignDetailsComponent implements OnInit {
  ...
  constructor(private _location: Location, private http: HttpClient, private route: Router,private router: ActivatedRoute ,private bridgeService2: BridgeService,) {
