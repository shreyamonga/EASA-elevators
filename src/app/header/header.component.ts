...
for (let i = 0; i < this.appList.length; i++) {
  ...
  redirect(type:any,isExist:boolean){
    ...
    //             }
    if(type == '3'){
      window.open(this.bridgeService2.SuperbaseFrontUrl+'/assets/html/serve.html', '_blank');
    }
                else if(type == '2'){
                  window.open('/#/dashboard', '_blank');
                }
                else if(type == '1'){
                  window.open(this.bridgeService2.SuperbaseFrontUrl+'/assets/html/omini.html', '_blank');
                }
                else if(type == '4'){
                  window.open(this.bridgeService2.SuperbaseFrontUrl+'/assets/html/nexus.html', '_blank');
                }
                else if(type == '5'){
                  window.open(this.bridgeService2.SuperbaseFrontUrl+'/assets/html/pulse.html', '_blank');
                }
                else if(type == '6'){
                  window.open(this.bridgeService2.SuperbaseFrontUrl+'/assets/html/intel.html', '_blank');
                }
      else{
